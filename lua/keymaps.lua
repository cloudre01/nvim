...
-- Codeium
keymap("i", "<A-a>", function() return vim.fn['codeium#Accept']() end,
  { noremap = true, silent = true, expr = true, replace_keycodes = false })
keymap("i", "<A-[>", function() return vim.fn['codeium#CycleCompletions'](1) end,
...
-- Aerial
keymap("n", "<leader>a", "<cmd>lua require'aerial'.toggle()<CR>", opts)

-- Spectre
keymap("n", "<leader>sr", "<cmd>lua require('spectre').open()<CR>", opts)
keymap("v", "<leader>sr", "<cmd>lua require('spectre').open_visual()<CR>", opts)
keymap("n", "<leader>ss", "<cmd>lua require('spectre').open_file_search()<CR>", opts)
